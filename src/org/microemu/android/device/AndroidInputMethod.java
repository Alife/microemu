...
/*		
	...
	/*private int getKeyCode(KeyEvent keyEvent) {
		...
		default: 
            ...
            if (resultKeyCode == 0)if(deviceKeyCode!=0)resultKeyCode = -127-deviceKeyCode;
            }
	...
	public String getKeyName(int keyCode) throws IllegalArgumentException {
		...
		case Canvas.GAME_D:
			...
			break;
		default:
			if(keyCode>0)keyName = Character.toString((char) keyCode);else keyName="KEYCODE_"+String.valueOf(-keyCode);
		}
